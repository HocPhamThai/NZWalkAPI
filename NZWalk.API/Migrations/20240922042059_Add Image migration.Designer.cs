...
namespace NZWalk.API.Migrations
{
    ...
    [Migration("20240922042059_Add Image migration")]
            ...
            modelBuilder.Entity("NZWalk.API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fbc4207a-053e-4738-963e-5bd4380548b2"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("a7903a8d-9ad2-4972-9bf6-25191ee1cc1e"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("2b53f393-29af-4cd8-bc33-f33b863be184"),
                            Name = "Hard"
                        });
                });
